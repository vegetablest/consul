...
<Tab heading="Consul Enterprise" group="ENT">
...
<Tab heading="Consul Enterprise (partition, namespace)" group="ENT-Non-Default">
...
The following example registers a custom policy defined in `tgw-register.hcl`.
